...
public class SearchFormInputTest {
    ...
    public void notPositivePageShouldNotPass() {
        ...
        violations = validator.validate(new SearchFormInput("", "", NEGATIVE_PAGE, VALID_PAGESIZE));
        ...
        violations = validator.validate(new SearchFormInput("", "", ZERO_PAGE, VALID_PAGESIZE));
    ...
    public void notPositivePagesizeShouldNotPass() {
        ...
        violations = validator.validate(new SearchFormInput("", "", VALID_PAGE, NEGATIVE_PAGESIZE));
        ...
        violations = validator.validate(new SearchFormInput("", "", VALID_PAGE, ZERO_PAGESIZE));
